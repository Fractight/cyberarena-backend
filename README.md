...
| offset | Позволяет отступить от начала несколько предметов    |
| ------ | ---------------------------------------------------- |
| count  | Колчество предметов, которое должен возвратить сервер|

Пример запроса /shop/items?offset=5&count=2
